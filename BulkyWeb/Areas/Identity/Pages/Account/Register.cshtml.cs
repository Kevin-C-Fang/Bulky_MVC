...
namespace BulkyWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            // .GetAwaiter().GetResult() -> Same as await statement but since we are calling here.
            // Hacky way of seeding role table in ASPNetRoles database if a role doesn't exist than create all roles and insert into the table.
